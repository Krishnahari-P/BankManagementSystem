        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterestRate = table.Column<decimal>(type: "decimal(5,4)", nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "CAST(GETDATE() AS DATE)"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customer_AspNetUsers_ApprovedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HiredDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CAST(GETDATE() AS DATE)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CAST(GETDATE() AS DATE)"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CAST(GETDATE() AS DATE)"),
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "AccountId");
                    table.ForeignKey(
                        name: "FK_Transaction_AspNetUsers_ProcessedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customer_ApprovedByUserId",
                table: "Customer",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Customer_PAN",
                table: "Customer",
                column: "PAN",
                unique: true,
